 ...
 */
class ElencoAdapter(private val context: Context, private val casts: List<CastItem?>?) :
	RecyclerView.Adapter<ElencoAdapter.ElencoViewHolder>() {

	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ElencoViewHolder {
		val view = LayoutInflater.from(context).inflate(Layout.elenco_list_adapter, parent, false)
